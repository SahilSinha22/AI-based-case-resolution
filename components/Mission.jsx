...
import Case from "@/public/case-Law-1.jpg";
    ...
    <div className="bg-background text-foreground p-8">
      <div className='flex'> 
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="bg-card p-4 rounded-lg shadow-md">
                      <Image src={Case} alt="Judicial Records Access" className="rounded-lg mb-4" width={400} height={100} />
                    ...
                    <div className="bg-card p-4 rounded-lg shadow-md">
                      <Image src={Judicial2} alt="Learning Resource Hub" className="rounded-lg mb-4" width={400} height={100} />
                    ...
                    <div className="bg-card p-4 rounded-lg shadow-md">
                      <Image src={Judicial3} alt="Online Hearing Schedule" className="rounded-lg mb-4" width={400} height={100} />
