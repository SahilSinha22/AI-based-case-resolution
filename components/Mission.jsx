  ...
  return (
    <div className="bg-background text-foreground p-8">
                  <div className="text-center mb-8">
                    ...
                    <p className="text-muted-foreground">Our mission is to enhance the accessibility and efficiency of the judicial system by providing a seamless digital experience.</p>
