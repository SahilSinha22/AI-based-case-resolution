...
import Judge1 from "@/public/judge1.jpg";
import Judge2 from "@/public/Judge2.jpg";
import Judge3 from "@/public/Judge3.jpg";
                    ...
                    <div className="bg-background text-foreground py-12">
                      ...
                      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <div className="text-center">
                          <Image src={Judge1} alt="Portrait of Mr. Gautam Mishra, Attorney" className="mx-auto rounded-full mb-4" width={400} height={100} />
                        ...
                        <div className="text-center">
                          <Image src={Judge2} alt="Portrait of Mrs. Sarah K., Plaintiff" className="mx-auto rounded-full mb-4" width={400} height={100}/>
                        ...
                        <div className="text-center">
                          <Image src={Judge3} alt="Portrait of Ms. Emily R., Legal Researcher" className="mx-auto rounded-full mb-4" width={400} height={100} />
