...
const Footer = () => {
  ...
  <div class="container mx-auto text-center space-y-2">
    ...
    <div class="flex justify-center space-x-4 mt-4">
      <img src="https://placehold.co/100x50?text=Certified+Quality+Website" alt="Certified Quality Website" class="h-10" />
      <img src="https://placehold.co/100x50?text=SWAAS" alt="Powered by SWAAS" class="h-10" />
      <img src="https://placehold.co/100x50?text=NIC" alt="NIC" class="h-10" />
      <img src="https://placehold.co/100x50?text=Digital+India" alt="Digital India" class="h-10" />
    </div>
  </div>
</div>
  )
